Public Class Estudiante_CRUD
    ...
    Private Sub BtnGuardar_Click(sender As Object, e As EventArgs) Handles BtnGuardar.Click
        If (conexion.estudianteValidar(TxtCodigo.Text) = False) Then
            MsgBox(conexion.insertarE(TxtCodigo.Text, TxtNombre.Text, TxtPrimerApellido.Text, TxtSegundoApellido.Text, Val(TxtEdad.Text), CmbSexo.Text, cmbCodigoClase.Text))
            conexion.conexion.Close()
            Limpiar()
            MostrarDatos()
            TxtCodigo.Focus()
